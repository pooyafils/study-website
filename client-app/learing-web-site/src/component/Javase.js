...
import logo from '../image/javase1.jpg';
...
<div>
        <div className="container autosizing h-auto  mt-2    ">
            <div className="card">
                <div className="card-header text-center">دوره اموزشی جاوا </div>
                ...
                <div className="card-body">
                    ...
                    <a className="btn btn-info btn-block mt-2 " href="http://localhost:7070/download/24">دانلود سرفصل های این دوره </a>
                    <button className="btn btn-primary d-block m-3" data-toggle="collapse"
                            data-target="#collapse-btn-14">ثبت نام این دوره
                    </button>

                    <div className="collapse mb-5" id="collapse-btn-14">
                        <div className="card">
                            <div className="card-body">
                               لطفا با شماره 0912
                            </div>
